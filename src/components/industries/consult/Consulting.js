...
import imageModal4 from "./images/imageModal4.png";
...
const Consulting=()=>{
    ...
    useEffect(()=>{
        ...
        setCards([
            {
                heading: `Connect with your ideal customers`,
            ...
            {
                heading: `Experience a consultative approach`,
            ...
            {
                heading: `Keep your creative agile`,
    ...
    const modalArr = [{
        image: imageModal1,
        heading: "felis aliquam id volutpat",
    ...
    return(
        <div className="consulting_body">
            ...
            <div className="consulting_level_two">
                <div className="consulting_level_two_heading">
                    <h2>Harness the power of <span>Research Technology Provider</span>​</h2>
                </div>
                <div className="consulting_level_two_heading_card_parent">
                    {cards.map((card, index) => {
                        let i =
                            index <= cardIcons.length - 1 ? index : index % cardIcons.length;
                        return (
                            <div
                                className="consulting_level_two_heading_card_child"
                                key={index}
                                id={"`${index}`"}
                            >
            ...
            <div className="consulting_level_four">
                <h2>Capabilities</h2>
                <p> in ornare feugiat sit tristique nibh. Neque sit ac lacinia eu. Neque consectetur enim placerat duis phasellus. Facilisis mauris nulla mi placerat. Magnis interdum nisl felis fames velit odio. Scelerisque commodo nulla vitae neque sit aliquam at commodo eu. </p>
                <div className="consulting_level_four_sliding_info">
                    <AliceCarousel
            ...
            <div className="consulting_level_five">
                <div className="consulting_level_five_heading">
                    <p>Our static</p>
                    <h2>Numbers speak for <span>themselves</span></h2>
                </div>
                <div className="consulting_level_five_grid_parent">
                    <div className="consulting_level_five_grid_child">
                        {grid1.map((element, index)=>{
                            return(
                                <div className="consulting_level_five_grid_one">
                    ...
                    <div className="consulting_level_five_grid_child">
                        {grid2.map((element, index)=>{
                            return(
                                <div className="consulting_level_five_grid_two">
                                    <h2>{element.heading}</h2>
                                    <p>{element.text}</p>
                                </div>
                            )
                    ...
                    <div className="consulting_level_five_grid_child">
                        {grid3.map((element, index)=>{
                            return(
                                <div className="consulting_level_five_grid_three">
                                    <h2>{element.heading}</h2>
                                    <p>{element.text}</p>
                                </div>
                            )
            ...
            <div className="consulting_level_six">
                <div className="consulting_level_six_heading">
                ...
                <div className="consulting_level_six_sec">
                    <section>
