...
import imagesec1 from "./images/imagesec1.png";
import imagesec2 from "./images/imagesec2.png";
import image_slide1 from "./images/image_slide1.png";
import image_slide2 from "./images/image_slide2.png";
import image_slide3 from "./images/image_slide3.png";
import image_slide4 from "./images/image_slide4.png";
...
const FinancialServices = () => {
  ...
  const [secCard1, setSecCard1] = useState(true);
  const [secCard2, setSecCard2] = useState(true);
  ...
  return (
    <div className="financial_service_body">
      ...
      <div className="financial_service_level_three">
        <div className="financial_service_level_three_heading">
          <h2>Consulting solution services made </h2>
          <h2>smarter, faster, and easier</h2>
        </div>
        <div className="financial_service_level_three_heading_card_parent">
          {cards.map((card, index) => {
            let i =
              index <= cardIcons.length - 1 ? index : index % cardIcons.length;
            return (
              <div
                className="financial_service_level_three_heading_card_child"
                key={index}
                id={"`${index}`"}
              >
      ...
      <div className="financial_service_level_four">
        <div className="financial_service_level_four_sec">
          <section className="financial_service_level_four_sec_text">
            <h2>
            ...
            <img
              src={plus}
              alt="plus_image"
              onClick={() => setSecCard1(!secCard1)}
            />
          </section>
          <section className="financial_service_level_four_sec_img">
            {secCard1 ? (
              <img src={imagesec1} alt="image1" />
            ) : (
              <p>
        ...
        <div className="financial_service_level_four_sec">
          <section className="financial_service_level_four_sec_img">
            {secCard2 ? (
              <img src={imagesec2} alt="image2" />
            ) : (
              <p>
                Ipsum dolor sit amet consectetur. Donec sodales et enim lorem
                quam tristique. Tellus erat metus ut amet quis in nec maecenas.
                Sit in cum elit eget neque lorem et est at. Proin semper
                pulvinar pellentesque sed penatibus mi aliquet vitae hac. Purus
                augue luctus pellentesque aliquet egestas convallis eget. Tellus
                tortor scelerisque nunc porttitor. Ut justo faucibus convallis
                ullamcorper mauris enim vitae vulputate pellentesque. Dictum
                lectus id tincidunt senectus. Pretium nibh massa sed lectus sit
                lacus donec dui. Sed semper phasellus mattis urna sollicitudin
                malesuada vulputate pharetra. Id eu habitant eget suscipit.
                Praesent risus sit non sem eget. Ornare et rutrum sit sed
                suspendisse pellentesque. Nec auctor neque in gravida eget
                elementum urna.
              </p>
            )}
          </section>
          <section className="financial_service_level_four_sec_text">
            <h2>Open banking will offer a one-stop solution to gig workers</h2>
            <img
              src={plus}
              alt="plus_image"
              onClick={() => setSecCard2(!secCard2)}
            />
          </section>
        </div>
      </div>
      <div className="financial_service_level_five">
        <h2>Capabilities</h2>
        <p>
          {" "}
        ...
        <div className="financial_service_level_five_sliding_info">
          <AliceCarousel
      ...
      <div className="financial_service_level_six">
        ...
        <div className="financial_service_level_six_card_parent">
          {gridCards.map((element, index) => {
            return (
              <div
                id={index}
                className="financial_service_level_six_card_child"
              >
      ...
      <div className="financial_service_level_seven">
        <div className="financial_service_level_seven_heading">
        ...
        <div className="financial_service_level_seven_sec">
          <section>
