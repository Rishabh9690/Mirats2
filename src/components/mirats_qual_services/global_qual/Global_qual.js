...
const Global_qual=()=>{
    ...
    return (
        <div className="global_qual_body">
            <img src={banner} alt="banner" />
            <div className="global_qual__level_two">
                <div className="global_qual__level_two_heading">
                    <h2>Global qual made</h2>
                    <h2>smarter, faster, and easier</h2>
                </div>
                <div className="global_qual__level_two_heading_card_parent">
                    {cards.map((card, index)=>{
                        let i= index<= cardIcons.length-1 ? index: index%cardIcons.length;
                        return(
                            <div className="global_qual__level_two_heading_card_child" key={index} id={'`${index}`'}>
            ...
            <div className="global_qual__level_three">
                <h2>Why us <span>mirats insights ?</span></h2>
                <div className="global_qual__level_three_sliding_info">
                    <AliceCarousel
            ...
            <div className="global_qual__level_four">
                <p>Upcoming Surveys</p>
                <div className="global_qual__level_four_heading">
                    <h2>Your favourite upcoming</h2>
                    <h2>Quanlitative Solution</h2>
                </div>
                <div className="global_qual__level_four_surveys_parent">
                    {qualSurvey.map((element, index)=>{
                        return(
                            <div className="global_qual_level_four_surveys_child" key={index} id={`${index}`} onClick={survey_redirect}>
