...
import laptop_part1 from "./images/laptop_part1.svg";
import laptop_part2 from "./images/laptop_part2.svg";
import phone_part1 from "./images/phone_part1.svg";
import phone_part2 from "./images/phone_part2.svg";
...
import Grouptimg from "./images/Groupimg.svg";
...
const Digital_qual= ()=>{
    ...
    return (
        <div className="digital_qual_body">
            <Modal isOpen={modalIsOpen}> 
                <div className="digital_modal_body">
                    <img src={modalData.image} alt="image" />
                    <img src={remove} alt="remove" onClick={handleModalClose}/>
                    <div className="digital_modal_body_paragraph">
                        <h2>{modalData.heading}</h2>
                        <p>{modalData.text}</p>
                    </div>
                </div>
            </Modal>
            <img src={banner} alt="banne_image" />
            <div className="digital_qual__level_two">
                <div className="digital_qual__level_two_heading">
                    <h2>Digital qual made</h2>
                    <h2>smarter, faster, and easier</h2>
                </div>
                <div className="digital_qual__level_two_heading_card_parent">
                    {cards.map((card, index)=>{
                        let i= index<= cardIcons.length-1 ? index: index%cardIcons.length;
                        return(
                            <div className="digital_qual__level_two_heading_card_child" key={index} id={'`${index}`'}>
            ...
            <div className="digital_qual__level_three">
                <h2>Our digital qualitative<span> approaches</span></h2>
            </div>
            <div className="digital_qual__level_four">
                <div className="digital_qual__level_four_details">
                    <h2>Online Discussions</h2>
                    <p>Lorem ipsum dolor sit amet consectetur. Egestas neque amet arcu non. Tempor justo elementum aenean pellentesque quam egestas. </p>
                    <img src={Grouptimg} alt="GroupImage" />
                </div>
            </div>
            <div className="digital_qual__level_five">
                <section>
                    <h2>Web-Enabled Focus Groups & IDIs</h2>
                    <p>Expand your reach and increase your speed to market. QualMeeting®, our real-time interview solution for virtual focus groups and IDIs, combines the reassurance of visual and audio signals of in-person interactions with the convenience and reach of online.</p>
                    <div className="digital_qual__level_five_images">
                        <img src={laptop_part2} alt="laptop_part2" />
                        <img className="left_image" src={laptop_part1} alt="laptop_part1" />
                    </div>
                </section>
                <section>
                    <h2>Mobile Ethnographies</h2>
                    <p>Gain an unprecedented look into the homes and experiences of the consumer. Powered by our QualMobile® app, mobile ethnographies offer a dynamic way to collect detailed in-the-moment and in-the-emotion insights.</p>
                    <div className="digital_qual__level_five_images">
                        <img src={phone_part2} alt="phone_part2" />
                        <img className="right_image" src={phone_part1} alt="phone_part1" />
                    </div>
                </section>
            </div>
            <div className="digital_qual__level_six">
                <h2>Why us <span>mirats insights ?</span></h2>
                <div className="digital_qual__level_six_sliding_info">
                    <AliceCarousel
            ...
            <div className="digital_qual__level_seven">
                <p>Upcoming Surveys</p>
                <div className="digital_qual__level_seven_heading">
                    <h2>Your favourite upcoming</h2>
                    <h2>Quanlitative Solution</h2>
                </div>
                <div className="digital_qual__level_seven_surveys_parent">
                    {qualSurvey.map((element, index)=>{
                        return(
                            <div className="digital_qual__level_seven_surveys_child" key={index} id={`${index}`} onClick={survey_redirect}>
